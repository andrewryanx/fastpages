...
![](https://github.com/andrewryanx/site/workflows/CI/badge.svg) 
![](https://github.com/andrewryanx/site/workflows/GH-Pages%20Status/badge.svg) 
...
* Resources page
* blog/projects to add:
    * ds/ai/ml glossary
    * pytorch
        * classifier
    * tensorflow
        * lstm stok price prediction
    * scikit-learn
        * regression

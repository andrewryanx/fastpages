...
var querystem = "https://andrew-ryan.carto.com/api/v2/sql?format=GeoJSON&q=SELECT * FROM dmv_tweets_20170309_20170314";
var query = querystem
...
// add popup with info
layer.bindPopup("<b>" + "User Name: " + "</b>" + feature.properties.user_name + '</b><br>' + "<b>" + "UserID: " + "</b>" + feature.properties.user_id + '</b><br>' + "<b>" + "Created At: " + "</b>" + feature.properties.timestamp + '</b><br>' + "<b>" + "Coordinates: " + "</b>" + feature.properties.latitude + "," +feature.properties.longitude + '</b><br>');
					 },
